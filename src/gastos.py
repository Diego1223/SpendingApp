...
class Clase_gastos:
    ...
    # Restaurar valores del ProgressBar
    ...
    # Cambiar colores del botón Gastos
    ...
    def Gastos(self, e=None):
        ...
        # CONTENEDOR 1: VIAJES Y TRANSPORTE
            ...
            content=ft.Row(
                ...
                controls=[
                    ...
                    ft.IconButton(
                        ...
                        on_click=self.restaurar_valores
                    ),
                ]
            )
        )
        ...
        self.app.main_content.controls.extend([
            self.row_4,
            self.row_5,
            self.row_6
        ])
